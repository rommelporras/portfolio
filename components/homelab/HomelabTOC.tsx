...
const sections = [
  ...
  { id: 'why-homelab', label: 'Why Homelab' },
...
export default function HomelabTOC() {
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-gray-900/80 backdrop-blur-lg rounded-xl border border-gray-700/50 shadow-lg p-3 max-h-[70vh] overflow-y-auto"
      >
